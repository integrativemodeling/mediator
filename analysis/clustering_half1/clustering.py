...
mc=IMP.pmi.macros.AnalysisReplicaExchange0(model,
							   ...
							   "../modeling.split_density.scale_radii.two_bayesian_classes-1.5",
                               "../modeling.split_density.scale_radii.two_bayesian_classes-1.6",
...
mc.clustering("SimplifiedModel_Total_Score_None",  # don't change, field where to find the score
              ...
              prefiltervalue=1817.8,               # prefilter the models by score
